...
meanData2 = np.loadtxt("G:\\ifres\\newcomb\\a0-n1-mean.csv", delimiter=',')
meanData3 = np.loadtxt("G:\\ifres\\newcomb\\a0-n2-mean.csv", delimiter=',')
meanData4 = np.loadtxt("G:\\ifres\\newcomb\\a0-n3-mean.csv", delimiter=',')
meanData5 = np.loadtxt("G:\\ifres\\newcomb\\a0-n4-mean.csv", delimiter=',')
meanData6 = np.loadtxt("G:\\ifres\\comb\\a0-mean.csv", delimiter=',')
cn0 = 27.019 # a0
cn = 27.019 # a0
# cn = 27.017 # a1
# cn = 27.01728080 # a2
...
scores1 = vscorefunc0(meanData1[:, 1])
scores2 = vscorefunc(meanData2[:, 1])
scores3 = vscorefunc(meanData3[:, 1])
scores4 = vscorefunc(meanData4[:, 1])
scores5 = vscorefunc(meanData5[:, 1])
scores6 = vscorefunc(meanData6[:, 1])
...
for i in range(0, 601):
    ...
    count6 = cstt * np.count_nonzero(scores6 > scorestart + i * 0.0005)
    ...
    sig6 = math.sqrt(137.1) * (count6 - count1) / math.sqrt(count6)
    print(scorestart + i * 0.0005, sig2, sig3, sig4, sig5, sig6)

# """

"""
count1 = cstt * np.count_nonzero(scores1 > 0.645)
count2 = cstt * np.count_nonzero(scores2 > 0.645)
count3 = cstt * np.count_nonzero(scores3 > 0.645)
count4 = cstt * np.count_nonzero(scores4 > 0.645)
count5 = cstt * np.count_nonzero(scores5 > 0.645)
